...
const (
	TelemetryService_SendData_FullMethodName = "/telemetry.v1.TelemetryService/SendData"
)
...
func (c *telemetryServiceClient) SendData(ctx context.Context, in *SendDataRequest, opts ...grpc.CallOption) (*SendDataResponse, error) {
...
func (UnimplementedTelemetryServiceServer) SendData(context.Context, *SendDataRequest) (*SendDataResponse, error) {
...
func _TelemetryService_SendData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).SendData(ctx, req.(*SendDataRequest))
	}
